...
1. Go to the [Security tab](https://github.com/Kinsman4249/doomgeneric-WASM-builder/security) of this repository.
...
- Insecure default configurations written by this project's setup or install code
